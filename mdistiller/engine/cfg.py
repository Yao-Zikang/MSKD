...
# MSKD CFG
CFG.MSKD = CN()
CFG.MSKD.IF_NORMALIZE = True

CFG.MSKD.CAMs_Nums = 100
CFG.MSKD.Strategy = 0

CFG.MSKD.LOSS = CN()
CFG.MSKD.LOSS.CE_WEIGHT = 1.0
CFG.MSKD.LOSS.CAT_loss_weight = 400.0
CFG.MSKD.LOSS.CAM_RESOLUTION = 2
CFG.MSKD.LOSS.sim_weight = 0.5
CFG.MSKD.LOSS.T = 4.0

CFG.MSKD.teacher_dir = None
CFG.MSKD.student_dir = None
